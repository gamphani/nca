...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { cluster: @facility.cluster, district: @facility.district, facility_name: @facility.facility_name, proprieter: @facility.proprieter }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { cluster: @facility.cluster, district: @facility.district, facility_name: @facility.facility_name, proprieter: @facility.proprieter }
    assert_redirected_to facility_path(assigns(:facility))
  end
